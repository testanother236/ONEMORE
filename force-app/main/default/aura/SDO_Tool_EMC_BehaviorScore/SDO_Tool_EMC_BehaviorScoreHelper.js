({
    ...
    getRecordData : function(component){
        ...
        return new Promise($A.getCallback(function(resolve,reject){
            ...
            let action = component.get('c.getRecordData');
            
            action.setParams({
                recordId: recordId,
                sobjectType: recordId.startsWith('003') ? 'Contact' : 'Lead'
            })
            ...
            action.setCallback(this,function(res){
                ...
                if(state === 'SUCCESS'){
                    if(self.VERBOSE) console.log('SUCCES:getRecordData',retVal);
    ...
    getLeadIQConfiguration: function(component){
        let self = this;
        if(self.VERBOSE) console.log('getLeadIQConfiguration');
        return new Promise($A.getCallback(function(resolve,reject){
    ...
    getScoreIntelligence : function(component){
        ...
        return new Promise($A.getCallback(function(resolve,reject){
            let recordId = component.get('v.recordId');
            let action = component.get('c.getEngagementScore');
