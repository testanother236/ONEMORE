({
    ...
    requiredFieldsMap: {
        HighEmailOpenRate : ['EngagementRate'],
        LowEmailOpenRate : ['EngagementRate'],
        HighEmailOpenRateWithContent : ['EngagementRate','EmailTitlePhrase'],
        LowEmailOpenRateWithContent : ['EngagementRate','EmailTitlePhrase'],
        HighEngagingAudienceSegment : ['EngagementRate'],
        LowEngagingAudienceSegment : ['EngagementRate'],
        Internal: ['InternalRationale'],
        ProspectSegmentCountry : ['Country'],
        ProspectSegmentState : ['State'],
        ProspectSegmentIndustry : ['Industry'],
        ProspectSegmentJobTitle : ['JobTitle'],
        PositiveEmailEngagement : ['NumberOfDays'],
        NegativeEmailEngagement : ['NumberOfDays'],
        FormSubmissions : ['NumberOfDays'],
        FormHandlerSubmissions : ['NumberOfDays'],
        LandingPageSubmissions : ['NumberOfDays'],
        FileViews : ['NumberOfDays'],
        SiteSearchQueries : ['NumberOfDays'],
        WebsiteVisits : ['NumberOfDays'],
        PageViews : ['NumberOfDays']
    },
    hasRequiredFields: function(component){
        ...
        return new Promise(
            $A.getCallback(function(resolve,reject){
                let requiredFields = self.requiredFieldsMap[insight.InsightType]
                let isValid = true
