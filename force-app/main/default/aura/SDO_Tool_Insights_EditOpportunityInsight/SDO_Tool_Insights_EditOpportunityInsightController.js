  ...
  doInit: function (component, event, helper) {
    ...
    Promise.all(promises)
      .then(function () {
        ...
        if (insightTrend && insight.Type)
          insightTrend.set("v.value", insight.Type);
        if (insightTrendType && insight.TrendType)
          insightTrendType.set("v.value", insight.TrendType);
        if (insightReason && insight.Reason)
          insightReason.set("v.value", insight.Reason);
